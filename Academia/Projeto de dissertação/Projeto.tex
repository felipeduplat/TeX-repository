...
\usepackage{lscape}                    % modo paisagem.
...
\begin{landscape}
	...
	\begin{table}[h]
		...
		\begin{tabular}{|l|cccccccccccc|}
			\hline
			\multicolumn{1}{|c|}{\multirow{2}{*}{Atividades}} & \multicolumn{12}{c|}{meses}                                                                                                                                                                                                                                                             \\ \cline{2-13} 
			\multicolumn{1}{|c|}{}                            & \multicolumn{1}{c|}{1} & \multicolumn{1}{c|}{2} & \multicolumn{1}{c|}{3} & \multicolumn{1}{c|}{4} & \multicolumn{1}{c|}{5} & \multicolumn{1}{c|}{6} & \multicolumn{1}{c|}{7} & \multicolumn{1}{c|}{8} & \multicolumn{1}{c|}{9} & \multicolumn{1}{c|}{10} & \multicolumn{1}{c|}{11} & 12 \\ \hline
