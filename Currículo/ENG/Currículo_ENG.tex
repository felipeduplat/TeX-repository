...
\geometry{left=1cm,right=9cm,marginparwidth=6.8cm,marginparsep=0.8cm,top=0.5cm,bottom=1cm}
...
\begin{itemize}
	\item Elaboration of monthly reports on local unemployment and special reports on social groups.
\end{itemize}
