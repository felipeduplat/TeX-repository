...
\include{Pré/Folha_de_aprovação}        % folha de aprovação.
...
\include{Pré/Abstract}                  % abstract (vem antes se trabalho for em inglês).
...
\include{Pré/Abreviaturas}              % abreviaturas.
\include{Pré/Símbolos}                  % símbolos.
